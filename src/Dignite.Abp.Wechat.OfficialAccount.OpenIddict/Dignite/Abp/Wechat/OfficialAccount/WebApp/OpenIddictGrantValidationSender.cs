...
using Dignite.Abp.Wechat.OfficialAccount.OpenIddict;
...
{
    private readonly WechatOfficialAccountOpenIddictAuthOptions _openIddictAuthOptions;
    private readonly IHttpClientFactory _clientFactory;
    private readonly IHttpContextAccessor _accessor;

    public OpenIddictGrantValidationSender(IOptions<WechatOfficialAccountOpenIddictAuthOptions> _options, IHttpClientFactory clientFactory, IHttpContextAccessor accessor)
    {
