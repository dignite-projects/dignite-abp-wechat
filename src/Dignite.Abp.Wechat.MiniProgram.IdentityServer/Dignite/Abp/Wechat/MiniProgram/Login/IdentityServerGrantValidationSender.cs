...
{
    private readonly WechatMiniProgramIdentityServerAuthOptions _identityServerAuthOptions;
    private readonly IHttpClientFactory _clientFactory;
    private readonly IHttpContextAccessor _accessor;

    public IdentityServerGrantValidationSender(IOptions<WechatMiniProgramIdentityServerAuthOptions> _options, IHttpClientFactory clientFactory, IHttpContextAccessor accessor)
    {
