...
{
    private readonly IWebsiteAppApiService _apiService;
    private readonly IHttpContextAccessor _httpContextAccessor;

    public IdentityServerGrantValidator(
        IWebsiteAppApiService apiService,
    ...
    public string GrantType => IdentityServerConsts.WechatOpenPlatformGrantType;
