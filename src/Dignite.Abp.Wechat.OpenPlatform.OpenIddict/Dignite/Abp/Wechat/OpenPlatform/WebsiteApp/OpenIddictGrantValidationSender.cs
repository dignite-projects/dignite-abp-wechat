...
/// <summary>
/// 微信公众号程序在拿到code和state后，向 OpenIddict 发起登记请求
/// </summary>
public class OpenIddictGrantValidationSender : IGrantValidationSender, ITransientDependency
{
    private readonly WechatOpenPlatformOpenIddictAuthOptions _openIddictAuthOptions;
    private readonly IHttpClientFactory _clientFactory;
    private readonly IHttpContextAccessor _accessor;

    public OpenIddictGrantValidationSender(IOptions<WechatOpenPlatformOpenIddictAuthOptions> _options, IHttpClientFactory clientFactory, IHttpContextAccessor accessor)
    {
