...
using Dignite.Abp.Wechat.OpenPlatform.IdentityServer;
...
{
    private readonly WechatOpenPlatformIdentityServerAuthOptions _identityServerAuthOptions;
    private readonly IHttpClientFactory _clientFactory;
    private readonly IHttpContextAccessor _accessor;

    public IdentityServerGrantValidationSender(IOptions<WechatOpenPlatformIdentityServerAuthOptions> _options, IHttpClientFactory clientFactory, IHttpContextAccessor accessor)
    {
    ...
    {
        var grant_type = IdentityServerConsts.WechatOpenPlatformGrantType;
        var client_id = _identityServerAuthOptions.ClientId;
        var scopes = _identityServerAuthOptions.Scopes.JoinAsString(" ");

        var client = _clientFactory.CreateClient(OpenPlatformConsts.HttpClientName);
